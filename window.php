...
<div id="Layer2<?=($openedwindows); ?>" style="position:absolute; width:<?=$width?>px; height:21px; z-index:<?=(1+$openedwindows*2); ?>; left: <?=(61+$openedwindows*10); ?>px; top:<?php echo ($changesize+68+$openedwindows*10);?>px; " class="<?=$class; ?>"
...
<div id="smsg<?=($openedwindows); ?>" style="position:absolute; width:<?=$width?>px; height:195px; z-index:<?=(1+$openedwindows*2);?>; left: <?=(61+$openedwindows*10); ?>px; top:<?php echo ($changesize+90+$openedwindows*10);?>px;" class="<?=$bgcolor ;?>"><?php 